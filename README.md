...
- [Logician](https://github.com/Michael-A-Kuykendall/logician) [:package:](https://crates.io/crates/logician) - type-safe SMT solver driver.
...
- [sat-interface](https://github.com/yaspar-org/sat-interface) [:package:](https://crates.io/crates/sat-interface) - abstraction interface for SAT solvers.
...
- [Travis Hance](https://github.com/tjhance) - verified-memory-allocator.
...
- [Tristen Harr](https://github.com/TristenHarr) - Logicaffeine.
...
- [Mateusz Szpakowski](https://github.com/matszpk) - CNFGEN, CNFGEN 2, Exec-SAT.
